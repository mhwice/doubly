      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <AreaChart data={filteredData}>
            ...
            />
            <Area dataKey="count" type="natural" fill="url(#fillMobile)" stroke="var(--color-mobile)" stackId="a" />
            {/* <Area dataKey="linkId" type="natural" fill="url(#fillDesktop)" stroke="var(--color-desktop)" stackId="a" /> */}
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
