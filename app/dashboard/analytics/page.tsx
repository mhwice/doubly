  ...
  return (
    <div className="bg-[var(--dashboard-bg)]">
      <div className="h-full mx-[15%] flex flex-col">
        ...
        <p className="text-xs font-light text-muted-foreground">Collect valuable insights on user behaviour and site performance<br/>with detailed page view metrics. Gain knowledge on top pages.</p>
      </div>
