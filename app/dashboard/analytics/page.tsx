  ...
  return (
    <>
      ...
      <div className="h-full max-w-7xl mx-auto px-3 md:px-5 xl:px-10 flex flex-col">
        ...
        <p className="text-sm text-vsecondary w-[90%] sm:w-full xl:w-[400px]">Discover click sources, geographies, and volumes at a glance. Filter by date, location, or device to zero in.</p>
      </div>
