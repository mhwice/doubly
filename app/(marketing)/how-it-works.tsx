  ...
  return (
    ...
    >
      <div className="flex flex-col w-full items-center mb-5">
        ...
        <h2
          id="features-title"
          className="mt-3 inline-block bg-gradient-to-br from-gray-900 to-gray-800 bg-clip-text py-2 text-4xl font-bold tracking-tighter text-transparent sm:text-6xl md:text-6xl dark:from-gray-50 dark:to-gray-300"
        >
          Simple, straightforward link tracking
        </h2>
